void loadForHEK(Country@ nation)
{
    print("Loaded for HESSE-KASSEL nation!\n");

    nation.setCapitalProvince(566); //hesse
    ...
    nation.addLeader("Wilhelm II", 1, 2, 2, 3, 0);
	nation.addDivision(culture_list_1, "Infanterie-Division", "Hessen-kasselsche Armee", "Wilhelm II", 566, false, 0.0f);	//hesse
}