void loadForMEC(Country@ nation)
{
    print("Loaded for MECKLENBERG nation!\n");

    nation.setCapitalProvince(544); //mecklenburg
	...
	nation.addLeader("Carl Wilhelm von Both", 2, 4, 2, 3, 0);
	nation.addDivision(culture_list_1, "Infanterie-Division", "Großherzoglich Mecklenburgische Armee", "Carl Wilhelm von Both", 544, false, 0.0f);	//mecklenburg
}