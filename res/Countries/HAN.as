void loadForHAN(Country@ nation)
{
    print("Loaded for HANOVER nation!\n");

	nation.addMoney(10000.0f);

    nation.setCapitalProvince(534); //hanover
	...
	brig_list_1.push_back("infantry_regiment_1");
	brig_list_1.push_back("infantry_regiment_1");
	brig_list_1.push_back("cuirassier_regiment_1");
    ...
    nation.addLeader("Ernst August I", 1, 2, 2, 3, 0);
	nation.addDivision(culture_list_1, "Infanterie-Division", "1. Infanterie-Division", "Ernst August I", 534, false, 0.0f);

    nation.addLeader("Prince Adolphus Frederick I", 1, 2, 2, 3, 0);
	nation.addDivision(culture_list_1, "Infanterie-Division", "2. Infanterie-Division", "Prince Adolphus Frederick I", 534, false, 0.0f);
}