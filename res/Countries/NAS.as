void loadForNAS(Country@ nation)
{
    print("Loaded for NASSAU nation!\n");

    nation.setCapitalProvince(565); //nassau
	...
	nation.addLeader("August von Kruse", 1, 2, 2, 3, 0);
	nation.addDivision(culture_list_1, "Infanterie-Division", "Herzoglich Nassauische Armee", "August von Kruse", 565, false, 0.0f);	//nassau
